...
import DropdownOtherPost from '../post/components/DropdownOtherPost';
import DropdownPostPersonal from '../post/components/DropdownPostPersonal';
import Loading from '../../components/Loading';
import { profileUserCurrent } from '../../service/ProfilePersonal';
import FileViewer from '../../components/fileViewer';
import { getAllPostInGroup } from '../../service/publicGroup';


export default function AllPostGroup({ onPostsUpdated, groupId }) {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      setLoading(true);
      const response = await getAllPostInGroup(groupId);
      if (response) {
